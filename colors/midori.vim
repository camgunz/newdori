...
if &background == "dark" " set background=dark
  ...
  hi Normal               ctermfg=232     ctermbg=252     cterm=none      guifg=#000000   guibg=#ffffff   gui=none
  ...
  hi ModeMsg              ctermfg=232     ctermbg=252     cterm=none      guifg=#000000   guibg=#ffffff   gui=none
  hi MoreMsg              ctermfg=232     ctermbg=252     cterm=none      guifg=#000000   guibg=#ffffff   gui=none
  hi NonText              ctermfg=232     ctermbg=252     cterm=none      guifg=#000000   guibg=#ffffff   gui=none
  hi Pmenu                ctermfg=232     ctermbg=250     cterm=none      guifg=#000000   guibg=#bcbcbc   gui=none
  hi PmenuSbar            ctermfg=232     ctermbg=248     cterm=none      guifg=#000000   guibg=#a8a8a8   gui=none
  hi PmenuSel             ctermfg=252     ctermbg=29      cterm=none      guifg=#d0d0d0   guibg=#00875f   gui=none
  hi PmenuThumb           ctermfg=232     ctermbg=252     cterm=reverse   guifg=#000000   guibg=#ffffff   gui=reverse
  hi Question             ctermfg=2       ctermbg=1       cterm=none      guifg=#00cd00   guibg=#cd0000   gui=none
  hi Search               ctermfg=248     ctermbg=89      cterm=none      guifg=#a8a8a8   guibg=#87005f   gui=none
  hi SignColumn           ctermfg=232     ctermbg=246     cterm=none      guifg=#000000   guibg=#949494   gui=none
  hi SpecialKey           ctermfg=200     ctermbg=252     cterm=none      guifg=#ff00d7   guibg=#ffffff   gui=none
  ...
  hi TabLine              ctermfg=232     ctermbg=249     cterm=none      guifg=#000000   guibg=#b2b2b2   gui=none
  hi TabLineFill          ctermfg=232     ctermbg=249     cterm=none      guifg=#000000   guibg=#b2b2b2   gui=none
  hi TabLineSel           ctermfg=232     ctermbg=252     cterm=none      guifg=#000000   guibg=#ffffff   gui=none

  hi VertSplit            ctermfg=249     ctermbg=249     cterm=none      guifg=#b2b2b2   guibg=#b2b2b2   gui=none
  hi vimNumber            ctermfg=28      ctermbg=252     cterm=none      guifg=#008700   guibg=#ffffff   gui=none
  hi vimHiAttrib          ctermfg=29      ctermbg=252     cterm=none      guifg=#00875f   guibg=#ffffff   gui=none
  ...
  hi Constant             ctermfg=30      ctermbg=252     cterm=none      guifg=#008787   guibg=#ffffff   gui=none
  hi String               ctermfg=29      ctermbg=252     cterm=none      guifg=#00875f   guibg=#ffffff   gui=none
  hi Character            ctermfg=30      ctermbg=252     cterm=none      guifg=#008787   guibg=#ffffff   gui=none
  hi Number               ctermfg=30      ctermbg=252     cterm=none      guifg=#008787   guibg=#ffffff   gui=none
  hi Boolean              ctermfg=30      ctermbg=252     cterm=none      guifg=#008787   guibg=#ffffff   gui=none
  hi Float                ctermfg=30      ctermbg=252     cterm=none      guifg=#008787   guibg=#ffffff   gui=none

  hi Identifier           ctermfg=232     ctermbg=252     cterm=none      guifg=#000000   guibg=#ffffff   gui=none
  hi Function             ctermfg=232     ctermbg=252     cterm=none      guifg=#000000   guibg=#ffffff   gui=none

  hi Statement            ctermfg=28      ctermbg=252     cterm=none      guifg=#008700   guibg=#ffffff   gui=none
  hi Conditional          ctermfg=28      ctermbg=252     cterm=none      guifg=#008700   guibg=#ffffff   gui=none
  hi Repeat               ctermfg=28      ctermbg=252     cterm=none      guifg=#008700   guibg=#ffffff   gui=none
  hi Label                ctermfg=28      ctermbg=252     cterm=none      guifg=#008700   guibg=#ffffff   gui=none
  hi Operator             ctermfg=28      ctermbg=252     cterm=none      guifg=#008700   guibg=#ffffff   gui=none
  hi Keyword              ctermfg=28      ctermbg=252     cterm=none      guifg=#008700   guibg=#ffffff   gui=none
  hi Exception            ctermfg=28      ctermbg=252     cterm=none      guifg=#008700   guibg=#ffffff   gui=none

  hi PreProc              ctermfg=59      ctermbg=252     cterm=none      guifg=#5f5f5f   guibg=#ffffff   gui=none
  hi Include              ctermfg=59      ctermbg=252     cterm=none      guifg=#5f5f5f   guibg=#ffffff   gui=none
  hi Define               ctermfg=59      ctermbg=252     cterm=none      guifg=#5f5f5f   guibg=#ffffff   gui=none
  hi Macro                ctermfg=59      ctermbg=252     cterm=bold      guifg=#5f5f5f   guibg=#ffffff   gui=bold
  hi PreCondit            ctermfg=59      ctermbg=252     cterm=none      guifg=#5f5f5f   guibg=#ffffff   gui=none

  hi Type                 ctermfg=22      ctermbg=252     cterm=none      guifg=#085d08   guibg=#ffffff   gui=none
  hi StorageClass         ctermfg=22      ctermbg=252     cterm=none      guifg=#085d08   guibg=#ffffff   gui=none
  hi Structure            ctermfg=22      ctermbg=252     cterm=none      guifg=#085d08   guibg=#ffffff   gui=none
  hi Typedef              ctermfg=22      ctermbg=252     cterm=none      guifg=#085d08   guibg=#ffffff   gui=none

  hi Special              ctermfg=128     ctermbg=none    cterm=none      guifg=#af00d7                   gui=none
  hi SpecialChar          ctermfg=124     ctermbg=252     cterm=none      guifg=#af0000   guibg=#ffffff   gui=none
  hi Tag                  ctermfg=1       ctermbg=252     cterm=none      guifg=#cd0000   guibg=#ffffff   gui=none
  hi Delimiter            ctermfg=93      ctermbg=none    cterm=none      guifg=#8700ff                   gui=none
  hi SpecialComment       ctermfg=223     ctermbg=252     cterm=none      guifg=#ffd7af   guibg=#ffffff   gui=none
  ...
  hi DiffChange           ctermfg=232     ctermbg=252     cterm=none      guifg=#000000   guibg=#ffffff   gui=none
  hi DiffDelete           ctermfg=250     ctermbg=52      cterm=none      guifg=#bcbcbc   guibg=#5f0000   gui=none
  hi DiffText             ctermfg=250     ctermbg=23      cterm=none      guifg=#bcbcbc   guibg=#005f5f   gui=none

  hi diffAdded            ctermfg=29      ctermbg=252     cterm=none      guifg=#00875f   guibg=#ffffff   gui=none
  ...
  hi luaFunc              ctermfg=28      ctermbg=252     cterm=bold      guifg=#088208   guibg=#ffffff   gui=bold
  hi luaStatement         ctermfg=28      ctermbg=252     cterm=none      guifg=#088208   guibg=#ffffff   gui=none
  hi luaCond              ctermfg=28      ctermbg=252     cterm=none      guifg=#088208   guibg=#ffffff   gui=none
  hi luaElse              ctermfg=28      ctermbg=252     cterm=none      guifg=#088208   guibg=#ffffff   gui=none
  hi luaRepeat            ctermfg=28      ctermbg=252     cterm=none      guifg=#088208   guibg=#ffffff   gui=none
  hi luaFunction          ctermfg=22      ctermbg=252     cterm=bold      guifg=#085d08   guibg=#ffffff   gui=bold

  hi pythonBuiltin        ctermfg=28      ctermbg=252     cterm=bold      guifg=#088208   guibg=#ffffff   gui=bold
  hi pythonStatement      ctermfg=22      ctermbg=252     cterm=bold      guifg=#085d08   guibg=#ffffff   gui=bold
  hi pythonConditional    ctermfg=28      ctermbg=252     cterm=none      guifg=#088208   guibg=#ffffff   gui=none
  hi pythonRepeat         ctermfg=28      ctermbg=252     cterm=none      guifg=#088208   guibg=#ffffff   gui=none
  hi pythonOperator       ctermfg=28      ctermbg=252     cterm=none      guifg=#088208   guibg=#ffffff   gui=none
  hi pythonEscape         ctermfg=124     ctermbg=252     cterm=none      guifg=#af0000   guibg=#ffffff   gui=none
  hi pythonInclude        ctermfg=59      ctermbg=252     cterm=none      guifg=#5f5f5f   guibg=#ffffff   gui=none
  hi pythonDecorator      ctermfg=29      ctermbg=252     cterm=none      guifg=#00875f   guibg=#ffffff   gui=none
  hi pythonDecoratorName  ctermfg=29      ctermbg=252     cterm=none      guifg=#00875f   guibg=#ffffff   gui=none

  hi javaScriptGlobal     ctermfg=66      ctermbg=252     cterm=bold      guifg=#5f8787   guibg=#ffffff   gui=bold
  hi javaScriptFunction   ctermfg=22      ctermbg=252     cterm=bold      guifg=#085d08   guibg=#ffffff   gui=bold
  hi javaScriptIdentifier ctermfg=28      ctermbg=252     cterm=none      guifg=#088208   guibg=#ffffff   gui=none
  hi javaScriptValue      ctermfg=29      ctermbg=252     cterm=none      guifg=#08825e   guibg=#ffffff   gui=none
  hi javaScriptSpecial    ctermfg=124     ctermbg=252     cterm=none      guifg=#af0000   guibg=#ffffff   gui=none

  hi typescriptImport                ctermfg=66  ctermbg=none cterm=none guifg=#5f8787 guibg=#000000 gui=none
  hi typescriptExport                ctermfg=245 ctermbg=none cterm=none guifg=#8a8a8a guibg=#000000 gui=none
  hi typescriptCall                  ctermfg=232 ctermbg=252  cterm=none guifg=#000000 guibg=#ffffff gui=none
  hi typescriptIdentifier            ctermfg=66  ctermbg=none cterm=none guifg=#5f8787 guibg=#000000 gui=none
  hi typescriptIdentifier            ctermfg=30  ctermbg=252  cterm=none guifg=#008787 guibg=#ffffff gui=none
  hi typescriptVariable              ctermfg=22  ctermbg=252  cterm=none guifg=#085d08 guibg=#ffffff gui=none
  hi typescriptReserved              ctermfg=22  ctermbg=252  cterm=none guifg=#085d08 guibg=#ffffff gui=none
  hi typescriptOperator              ctermfg=22  ctermbg=252  cterm=none guifg=#085d08 guibg=#ffffff gui=none
  hi typescriptAccessibilityModifier ctermfg=245 ctermbg=none cterm=none guifg=#8a8a8a guibg=#000000 gui=none
  hi typescriptTemplateSB            ctermfg=90  ctermbg=none cterm=bold guifg=#870087 guibg=#000000 gui=bold
  hi typescriptOpSymbols             ctermfg=232 ctermbg=252  cterm=none guifg=#000000 guibg=#ffffff gui=none
  hi typescriptParens                ctermfg=232 ctermbg=252  cterm=none guifg=#000000 guibg=#ffffff gui=none
  hi typescriptLogicSymbols          ctermfg=232 ctermbg=252  cterm=none guifg=#000000 guibg=#ffffff gui=none
  hi typescriptBOMNavigatorProp      ctermfg=232 ctermbg=252  cterm=none guifg=#000000 guibg=#ffffff gui=none
  hi typescriptEndColons             ctermfg=232 ctermbg=252  cterm=none guifg=#000000 guibg=#ffffff gui=none
  hi typescriptTypeBrackets          ctermfg=30  ctermbg=none cterm=none guifg=#008787 guibg=#000000 gui=none
  hi typescriptTemplateTag           ctermfg=29  ctermbg=252  cterm=none guifg=#00875f guibg=#ffffff gui=none
  hi typescriptTemplate              ctermfg=29  ctermbg=252  cterm=none guifg=#00875f guibg=#ffffff gui=none

  hi goEscapeC            ctermfg=124     ctermbg=252     cterm=none      guifg=#af0000   guibg=#ffffff   gui=none

  hi cfType               ctermfg=59      ctermbg=252     cterm=bold      guifg=#5f5f5f   guibg=#ffffff   gui=bold
  hi cfScope              ctermfg=66      ctermbg=252     cterm=bold      guifg=#5f8787   guibg=#ffffff   gui=bold
  hi cfFunction           ctermfg=22      ctermbg=252     cterm=bold      guifg=#085d08   guibg=#ffffff   gui=bold
  hi cfFunctions          ctermfg=28      ctermbg=252     cterm=bold      guifg=#088208   guibg=#ffffff   gui=bold
  hi cfFunctionName       ctermfg=28      ctermbg=252     cterm=bold      guifg=#088208   guibg=#ffffff   gui=bold
  hi cfFunctionScope      ctermfg=28      ctermbg=252     cterm=none      guifg=#088208   guibg=#ffffff   gui=none
  hi cfCondition          ctermfg=28      ctermbg=252     cterm=none      guifg=#088208   guibg=#ffffff   gui=none
  hi cfScriptConditional  ctermfg=28      ctermbg=252     cterm=none      guifg=#088208   guibg=#ffffff   gui=none
  hi cfBranch             ctermfg=28      ctermbg=252     cterm=none      guifg=#088208   guibg=#ffffff   gui=none
  hi cfScriptBranch       ctermfg=28      ctermbg=252     cterm=none      guifg=#088208   guibg=#ffffff   gui=none
  hi cfScriptBlock        ctermfg=232     ctermbg=252     cterm=none      guifg=#000000   guibg=#ffffff   gui=none

  " These exist in CFML, but not CFScript, so they have to be set to whatever Normal is for consistency
  hi cfOperatorMatch      ctermfg=232     ctermbg=252     cterm=none      guifg=#000000   guibg=#ffffff   gui=none
