...
hi Constant         ctermfg=28      ctermbg=252     cterm=none      guifg=#008700   guibg=#d0d0d0   gui=none
hi String           ctermfg=28      ctermbg=252     cterm=none      guifg=#008700   guibg=#d0d0d0   gui=none
hi Character        ctermfg=28      ctermbg=252     cterm=none      guifg=#008700   guibg=#d0d0d0   gui=none
hi Number           ctermfg=28      ctermbg=252     cterm=none      guifg=#008700   guibg=#d0d0d0   gui=none
hi Boolean          ctermfg=28      ctermbg=252     cterm=none      guifg=#008700   guibg=#d0d0d0   gui=none
hi Float            ctermfg=28      ctermbg=252     cterm=none      guifg=#008700   guibg=#d0d0d0   gui=none
