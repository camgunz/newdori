...
hi Title                ctermfg=34      ctermbg=252     cterm=bold      guifg=#007f00   guibg=#d0d0d0   gui=bold 
...
hi cfFunctions          ctermfg=59      ctermbg=252     cterm=none      guifg=#5f5f5f   guibg=#d0d0d0   gui=none
hi cfFunctions          ctermfg=28      ctermbg=252     cterm=bold      guifg=#088208   guibg=#d0d0d0   gui=bold
hi cfFunctionScope      ctermfg=22      ctermbg=252     cterm=none      guifg=#085d08   guibg=#d0d0d0   gui=none
